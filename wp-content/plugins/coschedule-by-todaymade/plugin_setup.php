            ...
            <div class="setup-box">
                ...
                <div class="sign-in setup-section">
                    ...
                    <div class="form margin-top-10">
                        <label class="form-label text-left margin-top-10">Email</label>
                ...
                <div id="tm_coschedule_alert" class="margin-20 alert small" style="display:none;"></div>
                ...
                <div class="connecting setup-section hide">
                    ...
                    <div class="loading-icon margin-top-bottom-20"></div>
                ...
                <div class="connection-error setup-section hide">
                    ...
                    <button type="submit" class="btn btn-orange btn-block default margin-top-20" id="retry-connection-tests"><span class="icon-loop margin-right-10"></span>Try Again</button>
                ...
                <div class="finished setup-section hide">
                    <div class="header">
                        <h4 class="margin-bottom-10">Connection Successful! 🙌</h4>
                    ...
                    <a id="finish-button"><button type="submit" class="btn btn-orange btn-block default margin-top-20" id="">View Calendar</button></a>
                </div>
