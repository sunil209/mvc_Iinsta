                ...
                <div class="cos-plugin-wrapper">
                    <div class="cos-plugin-inner">
                        <div class="cos-plugin-header text-center">
                            <h3 class="aj-header-text white margin-0 margin-bottom-10">
                                Your CoSchedule Editorial Calendar Is Waiting
                            </h3>
                        ...
                        <div class="cos-plugin-body">
                            <div class="well text-center">
                                <p>
                                    <strong>
                                        Uh oh! It looks like you don't have sufficient user
                                        permissions to complete the setup of CoSchedule. Please
                                        contact your website administrator for assitance.
                                    </strong>
                                </p>
                                <p>
                                    <a href="http://coschedule.com/" target="_blank" rel="noopener">
                                        Learn More About CoSchedule
                                    </a> |
                                    <a href="http://coschedule.com/training-articles/how-do-i-install-the-coschedule-wordpress-plugin" target="_blank" rel="noopener">
                                        How To Install CoSchedule
                                    </a>
                                </p>
                            </div>
                        </div>
