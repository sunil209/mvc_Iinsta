...
class Settings extends \Hammer\WP\Settings {
	...
	public function __construct( $id, $is_multi ) {
		$this->email_subject_issue = __( 'Scan of {SITE_URL} complete. {ISSUES_COUNT} issues found.', wp_defender()->domain );
...
Official WPMU DEV Superhero', wp_defender()->domain );
	...
	public function labels( $key = null ) {
		$labels = [
			...
			'email_subject_issue'      => __( "Email Subject", wp_defender()->domain ),
