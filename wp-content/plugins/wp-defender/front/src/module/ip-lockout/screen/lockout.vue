...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            demo_link: function () {
                return this.vsprintf(this.__("This message will be displayed across your website during the lockout period. See a quick preview <a href=\"%s\">here</a>."), this.siteUrl('?def-lockout-demo=1&type=login'));
            }
        },
        mounted: function () {
            let self = this;
