		...
		$htmlShareButtonsForm .= '<div class="tab-pane fade" id="counters">';
			...
			$htmlShareButtonsForm .= '<div class="col-sm-7">';
                ...
                $opts = array(
                    'form_group' => false,
                    'type' => 'checkbox',
                    'name' => 'ssba_share_count_cache',
                    'label' => 'Share count cache',
                    'tooltip' => '',
                    'value' => 'Y',
                    'checked' => ( $arrSettings[ 'ssba_share_count_cache' ] == 'Y'  ? 'checked' : null ),
                );
                $htmlShareButtonsForm .= $ssbpForm->ssbp_input( $opts );
                ...
                $opts = array(
                    'form_group' => false,
                    'type' => 'input',
                    'name' => 'ssba_share_count_cache_time',
                    'label' => 'Share count cache time (seconds)',
                    'tooltip' => '',
                    'value' => $arrSettings[ 'ssba_share_count_cache_time' ],
                );
                $htmlShareButtonsForm .= $ssbpForm->ssbp_input( $opts );
