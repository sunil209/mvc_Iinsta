...
function ssba_settings() {
	...
	if(isset($_POST['ssbaData']))
	{
        ...
        $arrOptions = array(
            ...
            'ssba_share_count_cache' => ( isset( $ssbaPost[ 'ssba_share_count_cache' ] ) ? $ssbaPost[ 'ssba_share_count_cache' ] : NULL ),
            'ssba_share_count_cache_time' => ( isset( $ssbaPost[ 'ssba_share_count_cache_time' ] ) ? $ssbaPost[ 'ssba_share_count_cache_time' ] : NULL ),
