 ...
 */
class AmpMarketingDictionary extends RootSitemap {
  /**
   ...
   */
  public $path = 'marketing-dictionary-amp-sitemap.xml';
  ...
  public function getData() {
    ...
    $model = new \Instapage\Models\DictionaryTerm();
    ...
    if (!empty($posts)) {
      foreach ($posts as $post) {
        $data[] = [
          'loc' => str_replace('/marketing-dictionary/', '/marketing-dictionary-amp/', get_permalink($post->ID)),
          'priority' => '0.5',
          'changefreq' => 'daily',
