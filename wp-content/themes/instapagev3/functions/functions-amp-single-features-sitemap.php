 ...
 */
class AmpFeatures extends RootSitemap {
  /**
   ...
   */
  public $path = 'single-features-amp-sitemap.xml';
  ...
  public function getData() {
    ...
    $model = new \Instapage\Models\Feature();
    ...
    if (!empty($posts)) {
      foreach ($posts as $post) {
        $data[] = [
          'loc' => str_replace('/features/', '/features-amp/', get_permalink($post->ID)),
          'priority' => '0.5',
          'changefreq' => 'daily',
